...
/* C5535 compatibility aliases added for this PM project port.
 * The uploaded CSL headers are from the C55x5 family and mainly name
 * C5505/C5515 macros. For a TMS320C5535 CCS project, defining CHIP_5535
 * or CHIP_C5535 will route PLL/sysctrl code through the C55x5-compatible path.
 */
#ifdef CHIP_5535
#ifndef CHIP_C5505_C5515
#define CHIP_C5505_C5515
#endif
#endif
