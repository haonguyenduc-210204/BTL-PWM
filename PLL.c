 ...
 * on the C5505/C5515/C5535 DSP is used to generate clock for CPU and peripherals.
 ...
 *
 * C5535 DSP PLL register bit fileds are little different than that of C5505 DSP.
 * Use the 'PLL_Config' values defined 12.288MHz - 120MHz to verify PLL
 * configuration.
 *
 * NOTE: THIS TEST HAS BEEN DEVELOPED TO WORK WITH CHIP VERSIONS C5505 AND
 * C5535. MAKE SURE THAT PROPER CHIP VERSION MACRO CHIP_5505/CHIP_5535 IS
 * DEFINED IN THE FILE c55xx_csl\inc\csl_general.h.
 *
 * \subsection PLLy    TEST PROCEDURE:
 *  @li Open the CCS and connect the target (C5505/C5515/C5535 EVM)
 ...
 *
 * 20-Aug-2010. Added 1 MHz, 2 MHz, 12 MHz and 98 MHz for 5535.
 * 
 * 16-Oct-2010. Added # if defined CHIP_C5505_C5535
 * 
 * ============================================================================
 */
...
#if ((defined(CHIP_5505)) || (defined(CHIP_5515)) || (defined(CHIP_5535)) || (defined(CHIP_C5535)) || (defined(CHIP_C5505_C5515)) || (defined(CHIP_C5505_C5535)) )
